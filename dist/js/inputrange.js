...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputrange = __webpack_require__(3);
	
	var _inputrange2 = _interopRequireDefault(_inputrange);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	_vue2.default.component('range', _inputrange2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/zhouwei/Documents/FrontEnd/GitHub/vue-input-range/src/inputrange.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-49776a40&file=inputrange.vue!./../node_modules/sass-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./inputrange.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-49776a40&file=inputrange.vue!./../node_modules/sass-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./inputrange.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@charset \"UTF-8\";\nul {\n  list-style: none; }\n\nul, p {\n  padding: 0;\n  margin: 0; }\n\n.range-selector {\n  width: 100%;\n  font-size: inherit;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  cursor: pointer; }\n  .range-selector .range {\n    position: relative;\n    width: 100%;\n    height: 10px;\n    background: #b2dbfb;\n    border-radius: 10px;\n    margin-top: 20px; }\n    .range-selector .range .select-range {\n      background: #2196f3;\n      border-radius: 10px;\n      height: 100%; }\n    .range-selector .range .current {\n      position: absolute;\n      color: #2196f3;\n      top: -1em;\n      z-index: 1;\n      -webkit-transform: translate(-10px, -10px);\n              transform: translate(-10px, -10px);\n      cursor: pointer; }\n      .range-selector .range .current.transition {\n        -webkit-transition: all .3s ease;\n        transition: all .3s ease; }\n      .range-selector .range .current:after {\n        content: '\\2016';\n        background: white;\n        box-shadow: 0 0 10px -2px #eee;\n        display: block;\n        width: 20px;\n        height: 20px;\n        line-height: 20px;\n        text-align: center;\n        border-radius: 20px;\n        margin-top: 5px; }\n  .range-selector .range-num {\n    color: #2196f3;\n    position: relative;\n    width: 100%;\n    cursor: pointer; }\n    .range-selector .range-num li {\n      position: absolute;\n      top: -10px;\n      -webkit-transform: translate(-100%, 0);\n              transform: translate(-100%, 0); }\n      .range-selector .range-num li:first-child {\n        -webkit-transform: translate(0, 0);\n                transform: translate(0, 0);\n        z-index: -1; }\n      .range-selector .range-num li:last-child {\n        z-index: -1; }\n      .range-selector .range-num li:before {\n        width: 2px;\n        height: 20px;\n        background: #fff;\n        content: ' ';\n        display: block;\n        margin: auto; }\n", "", {"version":3,"sources":["/./src/inputrange.vue.style"],"names":[],"mappings":"AAAA,iBAAiB;AACjB;EACE,iBAAiB,EAAE;;AAErB;EACE,WAAW;EACX,UAAU,EAAE;;AAEd;EACE,YAAY;EACZ,mBAAmB;EACnB,0BAAkB;KAAlB,uBAAkB;MAAlB,sBAAkB;UAAlB,kBAAkB;EAClB,gBAAgB,EAAE;EAClB;IACE,mBAAmB;IACnB,YAAY;IACZ,aAAa;IACb,oBAAoB;IACpB,oBAAoB;IACpB,iBAAiB,EAAE;IACnB;MACE,oBAAoB;MACpB,oBAAoB;MACpB,aAAa,EAAE;IACjB;MACE,mBAAmB;MACnB,eAAe;MACf,UAAU;MACV,WAAW;MACX,2CAAmC;cAAnC,mCAAmC;MACnC,gBAAgB,EAAE;MAClB;QACE,iCAAyB;QAAzB,yBAAyB,EAAE;MAC7B;QACE,iBAAa;QACb,kBAAkB;QAClB,+BAA+B;QAC/B,eAAe;QACf,YAAY;QACZ,aAAa;QACb,kBAAkB;QAClB,mBAAmB;QACnB,oBAAoB;QACpB,gBAAgB,EAAE;EACxB;IACE,eAAe;IACf,mBAAmB;IACnB,YAAY;IACZ,gBAAgB,EAAE;IAClB;MACE,mBAAmB;MACnB,WAAW;MACX,uCAA+B;cAA/B,+BAA+B,EAAE;MACjC;QACE,mCAA2B;gBAA3B,2BAA2B;QAC3B,YAAY,EAAE;MAChB;QACE,YAAY,EAAE;MAChB;QACE,WAAW;QACX,aAAa;QACb,iBAAiB;QACjB,aAAa;QACb,eAAe;QACf,aAAa,EAAE","file":"inputrange.vue","sourcesContent":["@charset \"UTF-8\";\nul {\n  list-style: none; }\n\nul, p {\n  padding: 0;\n  margin: 0; }\n\n.range-selector {\n  width: 100%;\n  font-size: inherit;\n  user-select: none;\n  cursor: pointer; }\n  .range-selector .range {\n    position: relative;\n    width: 100%;\n    height: 10px;\n    background: #b2dbfb;\n    border-radius: 10px;\n    margin-top: 20px; }\n    .range-selector .range .select-range {\n      background: #2196f3;\n      border-radius: 10px;\n      height: 100%; }\n    .range-selector .range .current {\n      position: absolute;\n      color: #2196f3;\n      top: -1em;\n      z-index: 1;\n      transform: translate(-10px, -10px);\n      cursor: pointer; }\n      .range-selector .range .current.transition {\n        transition: all .3s ease; }\n      .range-selector .range .current:after {\n        content: '‖';\n        background: white;\n        box-shadow: 0 0 10px -2px #eee;\n        display: block;\n        width: 20px;\n        height: 20px;\n        line-height: 20px;\n        text-align: center;\n        border-radius: 20px;\n        margin-top: 5px; }\n  .range-selector .range-num {\n    color: #2196f3;\n    position: relative;\n    width: 100%;\n    cursor: pointer; }\n    .range-selector .range-num li {\n      position: absolute;\n      top: -10px;\n      transform: translate(-100%, 0); }\n      .range-selector .range-num li:first-child {\n        transform: translate(0, 0);\n        z-index: -1; }\n      .range-selector .range-num li:last-child {\n        z-index: -1; }\n      .range-selector .range-num li:before {\n        width: 2px;\n        height: 20px;\n        background: #fff;\n        content: ' ';\n        display: block;\n        margin: auto; }\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    dragStart: function dragStart(self) {
	      self.dragable = true;
	    },
	    dragMove: function dragMove(e, self) {
	      if (!self.dragable) return false;
	      var left = e.clientX - e.target.parentNode.offsetLeft;
	    ...
	    dragEnd: function dragEnd(e, self) {
	      self.getValByOffset(self.offsetLeft, self);
	      self.offsetLeft = (self.val - self.min) * self.wholeWidth / (self.max - self.min);
	      self.dragable = false;
	    },
	    getValByOffset: function getValByOffset(offsetLeft, self) {
	      var left = self.values[0];
	      var _iteratorNormalCompletion = true;
	      var _didIteratorError = false;
	      var _iteratorError = undefined;
	
	      try {
	        for (var _iterator = (0, _getIterator3.default)(self.values), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div @click=\"click($event, this)\" class=\"range-selector\"><div class=\"range\"><div :style=\"{width: ratio}\" class=\"select-range\"></div><div :style=\"{left: ratio}\" @mousedown=\"dragStart(this)\" class=\"current\">{{ val }}倍</div></div><ul class=\"range-num\"><li v-for=\"i in duration\" :style=\"{left: ((i - min) * 100 /(max - min)) + '%'}\">{{ i }}</li></ul></div>";
